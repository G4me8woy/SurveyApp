...
if ($conn !== false) {
    ...
    //for each questionnaireSet
    foreach ($questionnaireSet as $number => $questionSet) {

        //insert into questions table
        $feedback = mysqli_query($conn, "INSERT INTO questions (question) VALUES ('". $questionSet['question'] . "')");

        if (!$feedback) {
            $message = "data entery error encountered, entering";
        }
    }
    echo $message;
} else {
